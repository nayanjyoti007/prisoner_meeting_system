...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend_assets/css/button.css') }}">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Visitor Panel</span>
                    </a>
                ...
                @include('visitor.include.sidebar')
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <h4 class="mt-3" style="font-weight: 700;">@yield('headerTitle')</h4>
                        <!-- Search Box Start-->
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        ...
                                        @if (Auth::guard('visitor')->user()->profile)
                                            <img src="{{ asset('assam_police_logo.png') }}" alt
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">Hi....<br>
                                                        @if (Auth::guard('visitor')->user())
                                                            {{ Auth::guard('visitor')->user()->fullname }}
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
