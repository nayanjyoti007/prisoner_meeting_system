<div class="container-fluid">
    <div class="row">
        <i> Date:- {{ \Carbon\Carbon::parse($details->kyc_update_date)->format('d F Y') }}</i>
            ...
            <table class="table table-bordered" style="border-color: #4c535a;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($details->date)->format('d F Y') }}</td>
                    </tr>
                    ...
                    <tr>
                        <td>Voter Proof </td>
                        <td>
                            <a href="{{ isset($details) ? asset('storage/backend_images/upload/visitor/kyc/' . $details->voter_proof) : '' }}"
                                target="_blank">View File</a>
                        </td>
                    </tr>
...
<script>
    $(document).ready(function() {
        ...
        $("#kyc_verification_details_status_update_form").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.pending-visitor-account-kyc-verification-status-update') }}",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
